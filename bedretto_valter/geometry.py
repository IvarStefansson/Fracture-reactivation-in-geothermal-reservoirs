...
class BedrettoValter_Geometry(CubeDomainOrthogonalFractures):
    def set_domain(self) -> None:
        ...
        bounding_box = {
            ...
            "zmax": self.units.convert_units(0, "m"),
        }
    ...
    def set_fractures(self) -> None:
        ...
        # Interval 14
        interval_14 = [pp.create_elliptic_fracture(
            center=self.cb1(90),
        ...
        interval_13 = [
            pp.create_elliptic_fracture(
                center=self.cb1(110),
                major_axis=self.units.convert_units(150, "m"),
                minor_axis=self.units.convert_units(150, "m"),
                major_axis_angle=0,  # TODO?
        ...
        self._fractures = interval_14 + interval_13 + interval_12 + interval_11 + interval_10 + interval_9 + interval_8 + interval_7 